...
import com.easyterview.wingterview.interview.service.InterviewFacade;
...
public class InterviewController {
    ...
    public ResponseEntity<BaseResponse> goNextStage(@PathVariable String interviewId){
        NextRoundDto nextRoundDto = interviewFacade.goNextStage(interviewId);
    ...
    public ResponseEntity<BaseResponse> getInterviewStatus(){
        Object interviewStatusDto = interviewFacade.getInterviewStatus();
    ...
    public ResponseEntity<BaseResponse> makeQuestion(@PathVariable String interviewId, @RequestBody QuestionCreationRequestDto dto){
        Object responseDto = interviewFacade.makeQuestion(interviewId, dto);
    ...
    public ResponseEntity<BaseResponse> selectQuestion(@PathVariable String interviewId, @RequestBody QuestionSelectionRequestDto dto){
        interviewFacade.selectQuestion(interviewId, dto);
    ...
    public ResponseEntity<BaseResponse> sendFeedback(@PathVariable String interviewId, @RequestBody FeedbackRequestDto dto){
        interviewFacade.sendFeedback(interviewId, dto);
    ...
    public ResponseEntity<BaseResponse> startAiInterview(@RequestBody TimeInitializeRequestDto requestDto){
        AiInterviewResponseDto dto = interviewFacade.startAiInterview(requestDto);
...
//        interviewFacade.initializeInterviewTime(interviewId, dto);
...
//    }
    ...
    public ResponseEntity<BaseResponse> exitInterview(@PathVariable String interviewId){
        interviewFacade.exitInterview(interviewId);
    ...
    public ResponseEntity<BaseResponse> getInterviewId(@PathVariable String userId){
        InterviewIdResponse response = interviewFacade.getInterviewId(userId);
    ...
    public ResponseEntity<BaseResponse> requestSttFeedback(@PathVariable String userId){
        interviewFacade.requestSttFeedback(userId);
